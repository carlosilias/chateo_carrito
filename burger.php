        ...
        <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-2">
          ...
          <div class="col d-flex justify-content-center mb-4">
            <div class="card shadow mb-1  rounded" style="width: 22rem;">
              <h5 class="card-title pt-2 text-center" style="color: #FF0000;">Burger sencilla</h5>
              <img src="img/platos/b_clasica.png" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text text-black-30 description">125gr carne, verduras, salsas de la casa, queso morazrella, papas.</p>
          ...
          <div class="col d-flex justify-content-center mb-4">
            <div class="card shadow mb-1  rounded" style="width: 22rem;">
              <h5 class="card-title pt-2 text-center" style="color: #FF0000;">Burger Doble</h5>
              <img src="img/platos/b_doble.png" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text text-black-10 description">250gr carne, verduras, salsas de la casa, queso americano, tocineta, papas.</p>
          ...
          <div class="col d-flex justify-content-center mb-4">
            <div class="card shadow mb-1  rounded" style="width: 22rem;">
              <h5 class="card-title pt-2 text-center" style="color: #FF0000;">Burger Pollo</h5>
              <img src="img/platos/b_pollo.png" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text text-black-10 description">125gr pollo, verduras, salsas de la casa, queso americano, papas.</p>
                <h5 class="" style="color: #FF0000;">Precio: <span class="precio">$ 10000</span></h5>
                <div class="d-grid gap-2">
                <button  class="btn button">Añadir a Carrito</button>
              </div>
              </div>
          ...
          <div class="col d-flex justify-content-center mb-4">
            <div class="card shadow mb-1  rounded" style="width: 22rem;">
              <h5 class="card-title pt-2 text-center" style="color: #FF0000;">Burger Pollo doble</h5>
              <img src="img/platos/b_pollo2.png" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text text-black-10 description">250gr pollo, verduras, salsas de la casa, queso americano, papas.</p>
                <h5 class="" style="color: #FF0000;">Precio: <span class="precio">$ 16000</span></h5>
                <div class="d-grid gap-2">
                <button  class="btn button">Añadir a Carrito</button>
              </div>
          ...
          <div class="col d-flex justify-content-center mb-4">
            <div class="card shadow mb-1  rounded" style="width: 22rem;">
              <h5 class="card-title pt-2 text-center" style="color: #FF0000;">Burger triple</h5>
              <img src="img/platos/b_triple.png" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text text-black-10 description">triple carne o pollo, verduras, salsas de la casa,salsa bbq, tocineta, queso mozarella, tocineta, queso americano, papas.</p>
                <h5 class="" style="color: #FF0000;">Precio: <span class="precio">$ 26000</span></h5>
                <div class="d-grid gap-2">
                <button  class="btn button">Añadir a Carrito</button>
              </div>
              </div>
          ...
          <div class="col d-flex justify-content-center mb-4">
            <div class="card shadow mb-1  rounded" style="width: 22rem;">
              <h5 class="card-title pt-2 text-center" style="color: #FF0000;">Burger BBQ</h5>
              <img src="img/platos/b_bbq.png" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text text-black-10 description">750gr carne o pollo, verduras, salsas de la casa,salsa bbq, tocineta, queso mozarella, tocineta, queso americano, papas.</p>
    ...
    <div class="row">
      ...
      <div class="row mx-4">
        ...
        <ul class="mad-pagination justify-content-center">
            ...
            <li><a href="menu.php" class="prev mad-arrows"><img src="yummi_svg_icons/arrow_left.svg" alt="" class="svg"></a></li>
            <li><a href="menu.php" class="page-numbers">1</a></li>
            <li><a href="burger.php" class="page-numbers current">2</a></li>
            <li><a href="perro.php" class="page-numbers">3</a></li>
            <li><a href="pizza.php" class="page-numbers">4</a></li>
            <li><a href="perro.php" class="next mad-arrows"><img src="yummi_svg_icons/arrow_right.svg" alt="" class="svg"></a></li>
